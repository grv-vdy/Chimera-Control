...
struct cameraThreadWorkerInput {
	...
	// This queue is constantly being tried to get pop-ed by the imageGrabber, which get sigaled after a successful pop to grab the image from Hamamatsu
	ThreadsafeQueue<unsigned long long>	picBufferQueue;
	// Hamamatsu is set to this in the constructor of the hamamatsu camera.
